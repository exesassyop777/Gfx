...
local FAKE_UC_AMOUNT = 72000    -- UC数量  
...
if _G.Mytimer_ticker then
    -- Startup delayed by 2 seconds
    _G.Mytimer_ticker.AddTimer(2, refresh_basic_data)
    -- Refreshes every 1 second (to prevent it from being overwritten by the game).
